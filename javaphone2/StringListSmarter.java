//****************************
//StringListSmarter.java
//****************************

public class StringListSmarter
{
    private String[] list ; 
    ...
    // Constructor
    public StringListSmarter(boolean ordered, boolean duplicates)
    {
        list = new String[50] ;
        stringCount = 0 ;
        keepOrdered = ordered ;
    ...
    // Constructor
    public StringListSmarter(int capacity,boolean ordered, boolean duplicates)
    {
    ...
    // Constructor
    public StringListSmarter(int additionalCapacity, String supplementaryStrings)
    {
        /*
    ...
    public void insert(String str)
    {
        if(keepOrdered) {
            if(allowDuplicates) {
                ...
                insertOrderedNoDuplicates(str) ;
            }
        } else {
            if(allowDuplicates) {
                insertArrived(str) ;
            } else {
                insertArrivedNoDuplicates(str) ;
            }
        }
    }

    private void insertArrived(String str)
    {
    ...
    private void insertOrdered(String str)
    {
        int i, j ;
        // Check if there is space for (at least) one more item
        if(stringCount < list.length) {
    ...
    private void insertArrivedNoDuplicates(String str)
    {
        // Check if there is space for (at least) one more item
        if(stringCount < list.length) {
            // There is space so do the insertion
    ...
    private void insertOrderedNoDuplicates(String str)
    {
        int i, j ;
        // Check if there is space for (at least) one more item
        if(stringCount < list.length) {
